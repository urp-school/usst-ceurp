...
[#macro makeupReportFoot report]
    <table align="center" class="reportFoot" width="95%">
      ...
      <td width="20%"></td>
      <td width="30%">教师签名:</td>
      <td width="40%">成绩录入日期:${(report.courseGradeState.updatedAt?string('yyyy-MM-dd'))!}</td>
    </tr>
  </table>
[/#macro]
...
[#macro gaReportFoot report]
    <table align="center" class="reportFoot" width="95%">
      ...
      <td width="30%">教师签名:</td>
      <td width="40%">成绩录入日期:${(report.courseGradeState.getState(GA).updatedAt?string('yyyy-MM-dd'))!}</td>
    </tr>
  </table>
[/#macro]
